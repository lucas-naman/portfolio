...
export class ProjectsComponent implements OnInit {
  ...
  public projects:  Array<project> = [
    {name: "D Bets", sdesc: "Decentralized betting app on the ethereum Blockchain", logo: "assets/bets_logo.png", image: "assets/bets_image.png", desc: "Decentralized betting app on the ethereum Blockchain. Based on it's own ERC20 token the app let you bet on esports games and swap ethereum against the token on Uniswap. Everything in on the Ropsten Test Network.", repo: "https://github.com/lucas-naman/bets-decentralized", url: "https://bets-decentralized-a24hjhbwf-lucas-naman.vercel.app/  "},
